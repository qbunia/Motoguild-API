...
{
    public partial class Fourthcorrections : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupUser1", x => new { x.PendingGroupsId, x.PendingUsersId });
                    table.ForeignKey(
                        name: "FK_GroupUser1_Groups_PendingGroupsId",
                        column: x => x.PendingGroupsId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupUser1_Users_PendingUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupUser1_PendingUsersId",
                table: "GroupUser1",
